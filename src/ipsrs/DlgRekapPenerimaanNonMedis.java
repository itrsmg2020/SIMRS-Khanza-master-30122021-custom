...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Map<String, Object> param = new HashMap<>();    
                ...
                param.put("tglawal",TglBeli1.getSelectedItem());
                param.put("tglakhir",TglBeli2.getSelectedItem());
            if(nmjenis.getText().length() <= 0){
                ...
                "select ipsrspemesanan.tgl_pesan,ipsrspemesanan.no_faktur, "+
                    ...
                    " order by ipsrssuplier.nama_suplier ",param);
            } else {
                Valid.MyReportqry("rptRekapPenerimaanNonMedis2.jasper","report","::[ Rekap Penerimaan Barang Non Medis ]::",
                    "select ipsrspemesanan.tgl_pesan,ipsrspemesanan.no_faktur, "+
                        "ipsrspemesanan.kode_suplier,ipsrssuplier.nama_suplier, "+
                        "ipsrspemesanan.nip,petugas.nama,ipsrspemesanan.tgl_faktur, "+
                        "ipsrspemesanan.tgl_tempo,ipsrspemesanan.status,ipsrspemesanan.total2,ipsrspemesanan.ppn,"+
                        "ipsrspemesanan.meterai,ipsrspemesanan.tagihan,ipsrspemesanan.no_order,ipsrsdetailpesan.kode_brng,ipsrsbarang.nama_brng, "+
                        "ipsrsdetailpesan.kode_sat,kodesatuan.satuan,ipsrsdetailpesan.jumlah,ipsrsdetailpesan.harga, "+
                        "ipsrsdetailpesan.subtotal,ipsrsdetailpesan.dis,ipsrsdetailpesan.besardis,ipsrsdetailpesan.total,ipsrsjenisbarang.nm_jenis "+
                        " from ipsrspemesanan inner join ipsrssuplier inner join petugas  "+
                        " inner join ipsrsdetailpesan inner join ipsrsbarang inner join kodesatuan "+
                        " inner join ipsrsjenisbarang "+
                        " on ipsrsdetailpesan.kode_brng=ipsrsbarang.kode_brng "+
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.panggilUrl("billing/RekapPenerimaanNonMedisDistributor.php?petugas="+akses.getkode().replaceAll(" ","_")+"&tanggalawal="+Valid.SetTgl(TglBeli1.getSelectedItem()+"")+"&tanggalakhir="+Valid.SetTgl(TglBeli2.getSelectedItem()+""));
        }
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.panggilUrl("billing/RekapPenerimaanNonMedisJenisBarang.php?petugas="+akses.getkode().replaceAll(" ","_")+"&tanggalawal="+Valid.SetTgl(TglBeli1.getSelectedItem()+"")+"&tanggalakhir="+Valid.SetTgl(TglBeli2.getSelectedItem()+""));
        }
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void BtnPrint2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint2ActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.panggilUrl("billing/RekapPenerimaanNonMedisFaktur.php?petugas="+akses.getkode().replaceAll(" ","_")+"&tanggalawal="+Valid.SetTgl(TglBeli1.getSelectedItem()+"")+"&tanggalakhir="+Valid.SetTgl(TglBeli2.getSelectedItem()+""));
        }
        this.setCursor(Cursor.getDefaultCursor());
       ...
       Valid.tabelKosong(tabMode);
        try{   
            ps=koneksi.prepareStatement(
                    ...
                    " order by ipsrssuplier.nama_suplier ");
            try {
