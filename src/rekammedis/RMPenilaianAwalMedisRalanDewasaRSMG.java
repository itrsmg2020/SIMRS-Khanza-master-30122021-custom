 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRalanDewasaRSMG extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRalanDewasaRSMG(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Extremitas = new widget.ComboBox();
        jLabel54 = new widget.Label();
        Neurologi = new widget.ComboBox();
        ...
        jLabel12.setBounds(760, 390, 30, 23);
        ...
        FormInput.add(BB);
        BB.setBounds(800, 390, 45, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(850, 390, 30, 23);
        ...
        FormInput.add(TB);
        TB.setBounds(670, 390, 45, 23);

        jLabel15.setText("TB :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(640, 390, 30, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("x/menit");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(370, 420, 50, 23);
        ...
        FormInput.add(Nadi);
        Nadi.setBounds(320, 420, 45, 23);

        jLabel17.setText("Nadi :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(280, 420, 40, 23);

        jLabel18.setText("Suhu :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(610, 420, 40, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(650, 420, 45, 23);

        jLabel22.setText("TD :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(0, 420, 127, 23);
        ...
        FormInput.add(TD);
        TD.setBounds(130, 420, 76, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("°C");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(700, 420, 30, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("mmHg");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(210, 420, 50, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText(" Cm");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(720, 390, 30, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("x/menit");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(530, 420, 50, 23);
        ...
        KetPerilaku.setBounds(260, 500, 360, 23);

        jLabel26.setText("RR :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(440, 420, 40, 23);
        ...
        jLabel28.setBounds(490, 390, 70, 23);
        ...
        jLabel39.setBounds(270, 390, 70, 23);
        ...
        Perilaku.setBounds(130, 500, 118, 23);

        jLabel40.setText("Kepala :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 880, 127, 23);
        ...
        Kesadaran.setBounds(340, 390, 130, 23);

        jLabel41.setText("Masalah Perilaku :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 500, 127, 23);

        jLabel29.setText("SpO2 :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(750, 420, 40, 23);
        ...
        FormInput.add(SPO);
        SPO.setBounds(800, 420, 45, 23);

        jLabel35.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel35.setText("%");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(850, 420, 30, 23);
        ...
        Kepala.setBounds(130, 880, 128, 23);

        jLabel44.setText("Leher :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 910, 127, 23);
        ...
        FormInput.add(Leher);
        Leher.setBounds(130, 910, 128, 23);

        jLabel45.setText("Dada :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(0, 940, 127, 23);
        ...
        FormInput.add(Dada);
        Dada.setBounds(130, 940, 128, 23);

        jLabel46.setText("Jantung :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(0, 970, 127, 23);
        ...
        Jantung.setBounds(130, 970, 128, 23);

        jLabel49.setText("Paru-paru :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(270, 880, 95, 23);
        ...
        FormInput.add(Paru);
        Paru.setBounds(370, 880, 128, 23);

        jLabel50.setText("Perut / Punggung :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(270, 910, 95, 23);
        ...
        FormInput.add(Perut);
        Perut.setBounds(370, 910, 128, 23);

        jLabel51.setText("Pelvis :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(270, 940, 95, 23);

        Pelvis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Abnormal", "Tidak Diperiksa" }));
        Pelvis.setName("Pelvis"); // NOI18N
        Pelvis.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PelvisKeyPressed(evt);
            }
        });
        FormInput.add(Pelvis);
        Pelvis.setBounds(370, 940, 128, 23);

        jLabel52.setText("Genital :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(270, 970, 95, 23);
        ...
        Genital.setBounds(370, 970, 128, 23);
        ...
        jSeparator13.setBounds(0, 550, 880, 1);
        ...
        PanelWall.setBounds(50, 570, 809, 300);
        ...
        scrollPane8.setBounds(50, 1030, 810, 83);

        jLabel79.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel79.setText("Keterangan Tambahan :");
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(50, 1010, 140, 23);
        ...
        jSeparator14.setBounds(0, 1120, 880, 1);

        jLabel100.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel100.setText("IV. STATUS LOKALIS");
        jLabel100.setName("jLabel100"); // NOI18N
        FormInput.add(jLabel100);
        jLabel100.setBounds(10, 550, 180, 23);
        ...
        scrollPane9.setBounds(50, 1140, 810, 63);
        ...
        scrollPane12.setBounds(50, 1230, 810, 43);
        ...
        jSeparator16.setBounds(0, 1350, 880, 1);

        jLabel102.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel102.setText("VI. DIAGNOSA");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(10, 1210, 190, 23);
        ...
        scrollPane13.setBounds(50, 1370, 810, 153);

        jLabel103.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel103.setText("VII. RENCANA TINDAKAN / TERAPI");
        jLabel103.setName("jLabel103"); // NOI18N
        FormInput.add(jLabel103);
        jLabel103.setBounds(10, 1350, 190, 23);
        ...
        scrollPane14.setBounds(50, 1550, 810, 63);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-06-2022 14:27:05" }));
        ...
        jSeparator17.setBounds(0, 1530, 880, 1);
        ...
        jSeparator18.setBounds(0, 450, 880, 1);

        jLabel105.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel105.setText("III. ASESMEN PSIKOLOGIS");
        jLabel105.setName("jLabel105"); // NOI18N
        FormInput.add(jLabel105);
        jLabel105.setBounds(10, 450, 180, 23);
        ...
        FormInput.add(RR);
        RR.setBounds(480, 420, 45, 23);

        jLabel53.setText("Extremitas :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(500, 880, 95, 23);

        Extremitas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Abnormal", "Tidak Diperiksa" }));
        Extremitas.setName("Extremitas"); // NOI18N
        Extremitas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ExtremitasKeyPressed(evt);
            }
        });
        FormInput.add(Extremitas);
        Extremitas.setBounds(600, 880, 128, 23);

        jLabel54.setText("Neurologi :");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(500, 910, 95, 23);

        Neurologi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Abnormal", "Tidak Diperiksa" }));
        Neurologi.setName("Neurologi"); // NOI18N
        Neurologi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NeurologiKeyPressed(evt);
            }
        });
        FormInput.add(Neurologi);
        Neurologi.setBounds(600, 910, 128, 23);
        ...
        jSeparator19.setBounds(0, 1280, 880, 1);
        ...
        scrollPane15.setBounds(50, 1300, 810, 43);
        ...
        Psikologis.setBounds(130, 470, 118, 23);

        jLabel43.setText("Keadaan Umum :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(0, 470, 127, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ralan_rsmg","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",38,new String[]{
                    ...
                    KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),Keadaan.getSelectedItem().toString(),GCS.getText(),Kesadaran.getSelectedItem().toString(),TD.getText(),
                    Nadi.getText(),RR.getText(),Suhu.getText(),SPO.getText(),BB.getText(),TB.getText(),Psikologis.getSelectedItem().toString(),Perilaku.getSelectedItem().toString()+" "+KetPerilaku.getText(),Kepala.getSelectedItem().toString(),Leher.getSelectedItem().toString(),Dada.getSelectedItem().toString(),
                    Jantung.getSelectedItem().toString(),Paru.getSelectedItem().toString(),Perut.getSelectedItem().toString(),Pelvis.getSelectedItem().toString(),Genital.getSelectedItem().toString(),
                    Extremitas.getSelectedItem().toString(),Neurologi.getSelectedItem().toString(),KetLokalis.getText(),Penunjang.getText(),Diagnosis.getText(),Permasalahan.getText(),Rencana.getText(),Konsul.getText()
                })==true){
                    emptTeks();
            }
        }
    ...
    private void SuhuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SuhuKeyPressed
        Valid.pindah(evt,KetPerilaku,SPO);
    ...
    private void ExtremitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ExtremitasKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ExtremitasKeyPressed

    private void NeurologiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NeurologiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_NeurologiKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanDewasaRSMG dialog = new RMPenilaianAwalMedisRalanDewasaRSMG(new javax.swing.JFrame(), true);
    ...
    private widget.ComboBox Extremitas;
    ...
    private widget.ComboBox Neurologi;
    private widget.TextBox NmDokter;
    private usu.widget.glass.PanelGlass PanelWall;
    private widget.ComboBox Paru;
    private widget.ComboBox Pelvis;
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Leher.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());
            Dada.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            Jantung.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString());
            Paru.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());
            Perut.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
            Pelvis.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());
        ...
        try{
            ...
            try{
                ...
                if(rscekdata.next()){
                    ...
                    RR.setText(rscekdata.getString("rr"));
                    Suhu.setText(rscekdata.getString("suhu"));
                    GCS.setText(rscekdata.getString("gcs"));
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ralan","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpk=?,rpd=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,spo=?,bb=?,tb=?,kepala=?,gigi=?,tht=?,thoraks=?,abdomen=?,genital=?,ekstremitas=?,kulit=?,ket_fisik=?,ket_lokalis=?,penunjang=?,diagnosis=?,tata=?,konsulrujuk=?",36,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),Perilaku.getSelectedItem().toString(),GCS.getText(),Kesadaran.getSelectedItem().toString(),TD.getText(),Nadi.getText(),
                KetPerilaku.getText(),Suhu.getText(),SPO.getText(),BB.getText(),TB.getText(),Kepala.getSelectedItem().toString(),Leher.getSelectedItem().toString(),Dada.getSelectedItem().toString(),Jantung.getSelectedItem().toString(),Paru.getSelectedItem().toString(),Perut.getSelectedItem().toString(),Pelvis.getSelectedItem().toString(),Genital.getSelectedItem().toString(),KetLokalis.getText(),
