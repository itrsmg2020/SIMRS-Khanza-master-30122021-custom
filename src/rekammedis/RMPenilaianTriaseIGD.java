 ...
 * @author perpustakaan
 */
public final class RMPenilaianTriaseIGD extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianTriaseIGD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-05-2022 10:55:14" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianTriaseIGD dialog = new RMPenilaianTriaseIGD(new javax.swing.JFrame(), true);
