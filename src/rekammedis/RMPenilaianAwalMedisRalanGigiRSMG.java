 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRalanGigiRSMG extends javax.swing.JDialog {
    private final DefaultTableModel tabMode;
    private Connection koneksi=koneksiDB.condb();
    private sekuel Sequel=new sekuel();
    private validasi Valid=new validasi();
    private PreparedStatement ps,pscekdata;
    private ResultSet rs,rscekdata;
    private int i=0;
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRalanGigiRSMG(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        KetPerilaku.setDocument(new batasInput((byte)5).getKata(KetPerilaku));
        ...
        Rencana.setDocument(new batasInput((int)5000).getKata(Rencana));
    ...
    private void initComponents() {
        ...
        KetPerilaku = new widget.TextBox();
        ...
        RPO1 = new widget.TextArea();
        jLabel27 = new widget.Label();
        scrollPane6 = new widget.ScrollPane();
        RPO2 = new widget.TextArea();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 1630));
        ...
        jLabel9.setBounds(0, 260, 172, 23);
        ...
        jLabel12.setBounds(410, 420, 30, 23);
        ...
        FormInput.add(BB);
        BB.setBounds(450, 420, 45, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(500, 420, 30, 23);
        ...
        FormInput.add(TB);
        TB.setBounds(310, 420, 45, 23);

        jLabel15.setText("TB :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(280, 420, 30, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("x/menit");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(550, 390, 50, 23);
        ...
        FormInput.add(Nadi);
        Nadi.setBounds(500, 390, 45, 23);

        jLabel17.setText("Nadi :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(460, 390, 40, 23);

        jLabel18.setText("Suhu :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(790, 390, 40, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(830, 390, 45, 23);

        jLabel22.setText("TD :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(280, 390, 30, 23);
        ...
        FormInput.add(TD);
        TD.setBounds(310, 390, 76, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("°C");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(860, 390, 30, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("mmHg");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(390, 390, 50, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText(" Cm");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(360, 420, 30, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("x/menit");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(710, 390, 50, 23);

        KetPerilaku.setFocusTraversalPolicyProvider(true);
        KetPerilaku.setName("KetPerilaku"); // NOI18N
        KetPerilaku.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KetPerilakuKeyPressed(evt);
            }
        });
        FormInput.add(KetPerilaku);
        KetPerilaku.setBounds(260, 650, 360, 23);

        jLabel26.setText("RR :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(620, 390, 40, 23);

        jLabel37.setText("Riwayat Alergi :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(20, 320, 150, 23);
        ...
        Alergi.setBounds(180, 320, 680, 23);
        ...
        scrollPane1.setBounds(179, 90, 680, 43);
        ...
        scrollPane2.setBounds(180, 200, 680, 43);

        jLabel31.setText("Riwayat Penyakit Dahulu :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(20, 200, 150, 23);
        ...
        scrollPane4.setBounds(180, 260, 680, 42);
        ...
        jLabel33.setBounds(40, 90, 125, 23);
        ...
        scrollPane7.setBounds(180, 140, 680, 43);
        ...
        Perilaku.setBounds(130, 650, 118, 23);

        jLabel41.setText("Masalah Perilaku :");
        ...
        jSeparator13.setBounds(0, 700, 880, 1);
        ...
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/odontogram1.png"))); // NOI18N
        ...
        PanelWall.setBounds(40, 750, 730, 60);
        ...
        scrollPane8.setBounds(50, 1180, 810, 83);

        jLabel79.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel79.setText("Keterangan Tambahan :");
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(50, 1160, 140, 23);
        ...
        jSeparator14.setBounds(0, 1270, 880, 1);

        jLabel100.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel100.setText("IV. STATUS LOKALIS");
        ...
        scrollPane9.setBounds(50, 1290, 810, 63);
        ...
        jLabel101.setBounds(10, 1270, 190, 23);
        ...
        scrollPane12.setBounds(50, 1380, 810, 43);
        ...
        jSeparator16.setBounds(0, 1500, 880, 1);

        jLabel102.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel102.setText("VI. DIAGNOSA");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(10, 1360, 190, 23);
        ...
        scrollPane13.setViewportView(Rencana);

        FormInput.add(scrollPane13);
        scrollPane13.setBounds(50, 1520, 810, 153);

        jLabel103.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel103.setText("VII. RENCANA TINDAKAN / TERAPI");
        jLabel103.setName("jLabel103"); // NOI18N
        FormInput.add(jLabel103);
        jLabel103.setBounds(10, 1500, 190, 23);
        ...
        scrollPane14.setBounds(50, 1700, 810, 63);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-06-2022 10:41:05" }));
        ...
        jSeparator17.setBounds(0, 1680, 880, 1);

        jLabel104.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel104.setText("VIII. KONSUL/RUJUK");
        jLabel104.setName("jLabel104"); // NOI18N
        FormInput.add(jLabel104);
        jLabel104.setBounds(10, 1680, 190, 23);
        ...
        jSeparator18.setBounds(10, 590, 880, 1);

        jLabel105.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel105.setText("III. ASESMEN PSIKOLOGIS");
        jLabel105.setName("jLabel105"); // NOI18N
        FormInput.add(jLabel105);
        jLabel105.setBounds(10, 600, 180, 23);
        ...
        jSeparator19.setBounds(0, 1430, 880, 1);
        ...
        scrollPane15.setViewportView(Permasalahan);

        FormInput.add(scrollPane15);
        scrollPane15.setBounds(50, 1450, 810, 43);

        jLabel106.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel106.setText("VI. PERMASALAHAN");
        jLabel106.setName("jLabel106"); // NOI18N
        FormInput.add(jLabel106);
        jLabel106.setBounds(10, 1430, 190, 23);
        ...
        Keadaan.setBounds(130, 390, 118, 23);
        ...
        Psikologis.setBounds(130, 620, 118, 23);

        jLabel43.setText("Keadaan Umum :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(0, 620, 127, 23);

        jLabel14.setText("Ekstra Oral :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(0, 460, 172, 23);

        scrollPane5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane5.setName("scrollPane5"); // NOI18N

        RPO1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        RPO1.setColumns(20);
        RPO1.setRows(5);
        RPO1.setName("RPO1"); // NOI18N
        RPO1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                RPO1KeyPressed(evt);
            }
        });
        scrollPane5.setViewportView(RPO1);

        FormInput.add(scrollPane5);
        scrollPane5.setBounds(180, 460, 680, 42);

        jLabel27.setText("Intra Oral :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(0, 520, 172, 23);

        scrollPane6.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane6.setName("scrollPane6"); // NOI18N

        RPO2.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        RPO2.setColumns(20);
        RPO2.setRows(5);
        RPO2.setName("RPO2"); // NOI18N
        RPO2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                RPO2KeyPressed(evt);
            }
        });
        scrollPane6.setViewportView(RPO2);

        FormInput.add(scrollPane6);
        scrollPane6.setBounds(180, 520, 680, 42);

        PanelWall1.setBackground(new java.awt.Color(29, 29, 29));
        PanelWall1.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/odontogram2.png"))); // NOI18N
        ...
        PanelWall1.setBounds(176, 840, 460, 60);

        PanelWall2.setBackground(new java.awt.Color(29, 29, 29));
        PanelWall2.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/odontogram3.png"))); // NOI18N
        ...
        PanelWall2.setBounds(173, 900, 463, 70);

        PanelWall3.setBackground(new java.awt.Color(29, 29, 29));
        PanelWall3.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/odontogram4.png"))); // NOI18N
        ...
        javax.swing.GroupLayout PanelWall3Layout = new javax.swing.GroupLayout(PanelWall3);
        PanelWall3.setLayout(PanelWall3Layout);
        PanelWall3Layout.setHorizontalGroup(
            PanelWall3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 730, Short.MAX_VALUE)
        );
        PanelWall3Layout.setVerticalGroup(
            PanelWall3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 60, Short.MAX_VALUE)
        );

        FormInput.add(PanelWall3);
        PanelWall3.setBounds(40, 990, 730, 60);

        jRadioButton1.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton1.setText("17");
        ...
        jRadioButton1.setBounds(96, 730, 37, 23);
        ...
        jRadioButton2.setBounds(50, 730, 37, 23);
        ...
        jRadioButton3.setBounds(185, 730, 37, 23);
        ...
        jRadioButton4.setBounds(140, 730, 37, 23);

        jRadioButton5.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton5.setText("13");
        ...
        jRadioButton5.setBounds(274, 730, 37, 23);
        ...
        jRadioButton6.setBounds(230, 730, 37, 23);

        jRadioButton7.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton7.setText("11");
        ...
        jRadioButton7.setBounds(363, 730, 37, 23);
        ...
        jRadioButton8.setBounds(318, 730, 37, 23);

        jRadioButton9.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton9.setText("22");
        ...
        jRadioButton9.setBounds(450, 730, 37, 23);
        ...
        jRadioButton10.setBounds(407, 730, 37, 23);
        ...
        jRadioButton11.setBounds(540, 730, 37, 23);
        ...
        jRadioButton12.setBounds(495, 730, 37, 23);

        jRadioButton13.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton13.setText("26");
        ...
        jRadioButton13.setBounds(630, 730, 37, 23);
        ...
        jRadioButton14.setBounds(584, 730, 37, 23);

        jRadioButton15.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton15.setText("28");
        ...
        jRadioButton15.setBounds(718, 730, 37, 23);
        ...
        jRadioButton16.setBounds(676, 730, 37, 23);

        jRadioButton17.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton17.setText("85");
        ...
        jRadioButton17.setBounds(187, 970, 37, 23);

        jRadioButton18.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton18.setText("84");
        ...
        jRadioButton18.setBounds(230, 970, 37, 23);

        jRadioButton19.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton19.setText("83");
        ...
        jRadioButton19.setBounds(275, 970, 37, 23);

        jRadioButton20.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton20.setText("82");
        ...
        jRadioButton20.setBounds(320, 970, 37, 23);

        jRadioButton21.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton21.setText("81");
        ...
        jRadioButton21.setBounds(364, 970, 37, 23);

        jRadioButton22.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton22.setText("71");
        ...
        jRadioButton22.setBounds(407, 970, 37, 23);

        jRadioButton23.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton23.setText("72");
        ...
        jRadioButton23.setBounds(453, 970, 37, 23);

        jRadioButton24.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton24.setText("73");
        ...
        jRadioButton24.setBounds(497, 970, 37, 23);

        jRadioButton25.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton25.setText("74");
        ...
        jRadioButton25.setBounds(542, 970, 37, 23);

        jRadioButton26.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton26.setText("75");
        ...
        jRadioButton26.setBounds(585, 970, 37, 23);

        jRadioButton27.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton27.setText("55");
        ...
        jRadioButton27.setBounds(186, 810, 37, 23);

        jRadioButton28.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton28.setText("54");
        ...
        jRadioButton28.setBounds(230, 810, 37, 23);

        jRadioButton29.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton29.setText("53");
        ...
        jRadioButton29.setBounds(275, 810, 37, 23);

        jRadioButton30.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton30.setText("52");
        ...
        jRadioButton30.setBounds(320, 810, 37, 23);

        jRadioButton31.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton31.setText("51");
        ...
        jRadioButton31.setBounds(363, 810, 37, 23);

        jRadioButton32.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton32.setText("61");
        ...
        jRadioButton32.setBounds(407, 810, 37, 23);

        jRadioButton33.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton33.setText("62");
        ...
        jRadioButton33.setBounds(450, 810, 37, 23);

        jRadioButton34.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton34.setText("63");
        ...
        jRadioButton34.setBounds(495, 810, 37, 23);

        jRadioButton35.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton35.setText("64");
        ...
        jRadioButton35.setBounds(540, 810, 37, 23);

        jRadioButton36.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton36.setText("65");
        ...
        jRadioButton36.setBounds(584, 810, 37, 23);

        jRadioButton37.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton37.setText("47");
        ...
        jRadioButton37.setBounds(95, 1050, 37, 23);

        jRadioButton38.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton38.setText("48");
        ...
        jRadioButton38.setBounds(50, 1050, 37, 23);

        jRadioButton39.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton39.setText("45");
        ...
        jRadioButton39.setBounds(185, 1050, 37, 23);

        jRadioButton40.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton40.setText("46");
        ...
        jRadioButton40.setBounds(140, 1050, 37, 23);

        jRadioButton41.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton41.setText("43");
        ...
        jRadioButton41.setBounds(276, 1050, 37, 23);

        jRadioButton42.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton42.setText("44");
        ...
        jRadioButton42.setBounds(230, 1050, 37, 23);

        jRadioButton43.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton43.setText("41");
        ...
        jRadioButton43.setBounds(360, 1050, 37, 23);

        jRadioButton44.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton44.setText("42");
        ...
        jRadioButton44.setBounds(319, 1050, 37, 23);

        jRadioButton45.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton45.setText("32");
        ...
        jRadioButton45.setBounds(452, 1050, 37, 23);

        jRadioButton46.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton46.setText("31");
        ...
        jRadioButton46.setBounds(407, 1050, 37, 23);

        jRadioButton47.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton47.setText("34");
        ...
        jRadioButton47.setBounds(543, 1050, 37, 23);

        jRadioButton48.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton48.setText("33");
        ...
        jRadioButton48.setBounds(497, 1050, 37, 23);

        jRadioButton49.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton49.setText("36");
        ...
        jRadioButton49.setBounds(630, 1050, 37, 23);

        jRadioButton50.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton50.setText("35");
        ...
        jRadioButton50.setBounds(586, 1050, 37, 23);

        jRadioButton51.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton51.setText("38");
        ...
        jRadioButton51.setBounds(720, 1050, 37, 23);

        jRadioButton52.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton52.setText("37");
        ...
        jRadioButton52.setBounds(673, 1050, 37, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ralan_rsmg","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",38,new String[]{
                    TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                    KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),Keadaan.getSelectedItem().toString(),TD.getText(),
                    Nadi.getText(),RR.getText(),Suhu.getText(),BB.getText(),TB.getText(),Psikologis.getSelectedItem().toString(),Perilaku.getSelectedItem().toString()+" "+KetPerilaku.getText(),
                    KetLokalis.getText(),Penunjang.getText(),Diagnosis.getText(),Permasalahan.getText(),Rencana.getText(),Konsul.getText()
                })==true){
                    emptTeks();
            }
        }
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,KetLokalis,BtnBatal);
        }
    ...
    private void NadiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NadiKeyPressed
        Valid.pindah(evt,TD,KetPerilaku);
    ...
    private void KetPerilakuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KetPerilakuKeyPressed
        Valid.pindah(evt,Nadi,Suhu);
    }//GEN-LAST:event_KetPerilakuKeyPressed

    private void AlergiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AlergiKeyPressed
        Valid.pindah(evt,RPO,Perilaku);
    ...
    private void KonsulKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KonsulKeyPressed
        Valid.pindah2(evt,Rencana,BtnSimpan);
    ...
    private void RPO1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_RPO1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_RPO1KeyPressed

    private void RPO2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_RPO2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_RPO2KeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanGigiRSMG dialog = new RMPenilaianAwalMedisRalanGigiRSMG(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox KetPerilaku;
    ...
    private widget.TextArea RPO1;
    private widget.TextArea RPO2;
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            KetPerilaku.setText(tbObat.getValueAt(tbObat.getSelectedRow(),21).toString());
            ...
            Rencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(),38).toString());
    ...
    private void isRawat() {
        try{
            //Query Penambahan Otomasi Isian
            pscekdata=koneksi.prepareStatement(
                "select * from penilaian_awal_keperawatan_ralan "
                 + "where no_rawat=?"
            );
            
            //Cek Data Otomasi
            try{
                pscekdata.setString(1,TNoRw.getText());
                rscekdata=pscekdata.executeQuery();
                ...
                if(rscekdata.next()){
                    ...
                    //Tambahan Otomasi
                    TD.setText(rscekdata.getString("td"));
                    Nadi.setText(rscekdata.getString("nadi"));
                    KetPerilaku.setText(rscekdata.getString("rr"));
                    Suhu.setText(rscekdata.getString("suhu"));
                    BB.setText(rscekdata.getString("bb"));
                    TB.setText(rscekdata.getString("tb"));
                    KeluhanUtama.setText(rscekdata.getString("keluhan_utama"));
                    RPD.setText(rscekdata.getString("rpd"));
                    RPO.setText(rscekdata.getString("rpo"));
                    Alergi.setText(rscekdata.getString("alergi"));
                ...
                System.out.println("Notif Otomasi : "+e);
            }finally{
                if(rscekdata!=null){
                    rscekdata.close();
                }
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ralan","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpk=?,rpd=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,spo=?,bb=?,tb=?,kepala=?,gigi=?,tht=?,thoraks=?,abdomen=?,genital=?,ekstremitas=?,kulit=?,ket_fisik=?,ket_lokalis=?,penunjang=?,diagnosis=?,tata=?,konsulrujuk=?",36,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),Perilaku.getSelectedItem().toString(),TD.getText(),Nadi.getText(),
                KetPerilaku.getText(),Suhu.getText(),BB.getText(),TB.getText(),KetLokalis.getText(),
                Penunjang.getText(),Diagnosis.getText(),Rencana.getText(),Konsul.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){
               tampil();
               emptTeks();
               TabRawat.setSelectedIndex(1);
