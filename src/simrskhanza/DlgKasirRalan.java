...
import rekammedis.RMPenilaianAwalKeperawatanKebidananRSMG;
...
import rekammedis.RMPenilaianAwalMedisRalanDewasaRSMG;
import rekammedis.RMPenilaianAwalMedisRalanKandungan;
import rekammedis.RMPenilaianAwalMedisRalanGigiRSMG;
...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnPeniliaianAwalMedisRalanGigi = new javax.swing.JMenuItem();
        ...
        MnDaftarResepObat = new javax.swing.JMenuItem();
        ...
        ppPemasukanLain = new javax.swing.JMenuItem();
        ...
        ppPemasukanLain1 = new javax.swing.JMenuItem();
        ...
        MnPeniliaianAwalMedisRalanGigi.setBackground(new java.awt.Color(255, 255, 254));
        MnPeniliaianAwalMedisRalanGigi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPeniliaianAwalMedisRalanGigi.setForeground(new java.awt.Color(50, 50, 50));
        MnPeniliaianAwalMedisRalanGigi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPeniliaianAwalMedisRalanGigi.setText("Penilaian Awal Medis Gigi & Mulut");
        MnPeniliaianAwalMedisRalanGigi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPeniliaianAwalMedisRalanGigi.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPeniliaianAwalMedisRalanGigi.setName("MnPeniliaianAwalMedisRalanGigi"); // NOI18N
        MnPeniliaianAwalMedisRalanGigi.setPreferredSize(new java.awt.Dimension(310, 26));
        MnPeniliaianAwalMedisRalanGigi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPeniliaianAwalMedisRalanGigiActionPerformed(evt);
            }
        });
        MnRMRawatJalan.add(MnPeniliaianAwalMedisRalanGigi);
        ...
        MnDaftarResepObat.setBackground(new java.awt.Color(255, 255, 254));
        MnDaftarResepObat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnDaftarResepObat.setForeground(new java.awt.Color(50, 50, 50));
        MnDaftarResepObat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnDaftarResepObat.setText("Daftar Resep Dokter");
        MnDaftarResepObat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnDaftarResepObat.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnDaftarResepObat.setName("MnDaftarResepObat"); // NOI18N
        MnDaftarResepObat.setPreferredSize(new java.awt.Dimension(200, 26));
        MnDaftarResepObat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnDaftarResepObatActionPerformed(evt);
            }
        });
        MnObatRalan.add(MnDaftarResepObat);
        ...
        ppPemasukanLain.setBackground(new java.awt.Color(255, 255, 254));
        ppPemasukanLain.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppPemasukanLain.setForeground(new java.awt.Color(50, 50, 50));
        ppPemasukanLain.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppPemasukanLain.setText("Pemasukan Lain");
        ppPemasukanLain.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppPemasukanLain.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppPemasukanLain.setName("ppPemasukanLain"); // NOI18N
        ppPemasukanLain.setPreferredSize(new java.awt.Dimension(200, 26));
        ppPemasukanLain.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppPemasukanLainBtnPrintActionPerformed(evt);
            }
        });
        MenuInputData.add(ppPemasukanLain);
        ...
        ppPemasukanLain1.setBackground(new java.awt.Color(255, 255, 254));
        ppPemasukanLain1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppPemasukanLain1.setForeground(new java.awt.Color(50, 50, 50));
        ppPemasukanLain1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppPemasukanLain1.setText("Pemasukan Lain");
        ppPemasukanLain1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppPemasukanLain1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppPemasukanLain1.setName("ppPemasukanLain1"); // NOI18N
        ppPemasukanLain1.setPreferredSize(new java.awt.Dimension(200, 26));
        ppPemasukanLain1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppPemasukanLain1BtnPrintActionPerformed(evt);
            }
        });
        MenuInputData1.add(ppPemasukanLain1);
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-06-2022" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-06-2022" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-06-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-06-2022" }));
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnPeniliaianAwalKeperawatanKebidananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeniliaianAwalKeperawatanKebidananActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMPenilaianAwalKeperawatanKebidananRSMG form=new RMPenilaianAwalKeperawatanKebidananRSMG(null,false);
                form.isCek();
                form.emptTeks();
                form.setNoRm(TNoRw.getText(),DTPCari2.getDate());
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void MnPeniliaianAwalMedisRalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeniliaianAwalMedisRalanActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMPenilaianAwalMedisRalanDewasaRSMG form=new RMPenilaianAwalMedisRalanDewasaRSMG(null,false);
                form.isCek();
                form.setNoRm(TNoRw.getText(),DTPCari2.getDate());
//                form.emptTeks();
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void ppPemasukanLain1BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppPemasukanLain1BtnPrintActionPerformed
        if(tabModekasir2.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TNoReg.requestFocus();
        }else{
            if(tbKasirRalan2.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                DlgPemasukanLain pemasukan=new DlgPemasukanLain(null,false);
                pemasukan.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                pemasukan.setLocationRelativeTo(internalFrame1);
                pemasukan.isCek();
                pemasukan.setNoRm(TNoRw.getText());
                pemasukan.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    }//GEN-LAST:event_ppPemasukanLain1BtnPrintActionPerformed

    private void ppPemasukanLainBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppPemasukanLainBtnPrintActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
            ...
            pemasukan.setLocationRelativeTo(internalFrame1);
            pemasukan.isCek();
            pemasukan.setNoRm(TNoRMCari.getText() +" - "+ TPasienCari.getText());
            pemasukan.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_ppPemasukanLainBtnPrintActionPerformed

    private void MnDaftarResepObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDaftarResepObatActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnDaftarResepObatActionPerformed

    private void MnPeniliaianAwalMedisRalanGigiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeniliaianAwalMedisRalanGigiActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data registrasi sudah habis...!!!!");
            TNoRMCari.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMPenilaianAwalMedisRalanGigiRSMG formGigi=new RMPenilaianAwalMedisRalanGigiRSMG(null,false);
                formGigi.isCek();
                formGigi.setNoRm(TNoRw.getText(),DTPCari2.getDate());
                formGigi.emptTeks();
                formGigi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                formGigi.setLocationRelativeTo(internalFrame1);
                formGigi.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    }//GEN-LAST:event_MnPeniliaianAwalMedisRalanGigiActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnDaftarResepObat;
    ...
    private javax.swing.JMenuItem MnPeniliaianAwalMedisRalanGigi;
    ...
    private javax.swing.JMenuItem ppPemasukanLain;
    private javax.swing.JMenuItem ppPemasukanLain1;
