...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    public DlgCariObat(java.awt.Frame parent, boolean modal) {
        ...
        tabModeDetailObatRacikan=new DefaultTableModel(null,new Object[]{
                ...
                "Emb","Tsl","I.F.","Kategori","Golongan","No.Batch","No.Faktur","Kadaluarsa","Keterangan"
            }){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if ((colIndex==9)||(colIndex==10)||(colIndex==11)||(colIndex==12)||(colIndex==13)||(colIndex==16)||(colIndex==17)||(colIndex==19)) {
                    a=true;
                }
                return a;
             }
...
//                                            Tambahan Inputan Keterangan
                                            if(tbObat.getValueAt(i,19) != null){
                                                Sequel.menyimpan("detail_pemberian_keterangan","?,?,?,?,?",5,new String[]{
                                                    Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),TNoRw.getText(),tbObat.getValueAt(i,2).toString(),tbObat.getValueAt(i,19).toString()
                                                });  
                                            }
                            ...
                            if(Sequel.menyimpantf2("detail_obat_racikan","?,?,?,?,?","Data",5,new String[]{
                               ...
                               tbDetailObatRacikan.getValueAt(i,0).toString(),tbDetailObatRacikan.getValueAt(i,1).toString()
                                ...
                                if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",14,new String[]{
                                    ...
                                    //Tambahan Inputan Keterangan
                                    if(tbDetailObatRacikan.getValueAt(i,19) != null){
                                        Sequel.menyimpan("detail_pemberian_keterangan","?,?,?,?,?",5,new String[]{
                                            Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),TNoRw.getText(),tbDetailObatRacikan.getValueAt(i,1).toString(),tbDetailObatRacikan.getValueAt(i,19).toString()
                                        });  
                                    }
