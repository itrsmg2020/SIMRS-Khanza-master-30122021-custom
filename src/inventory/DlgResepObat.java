...
public final class DlgResepObat extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,ps2,psracikan,pscekkronis,psnotakronis,psketerangan;
    private ResultSet rs,rs2,rsracikan,rshasilkronis,rsnotakronis,rsketerangan;
    public DlgCariDokter dokter=new DlgCariDokter(null,false);
    private DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    private Date date = new Date();
    private String now=dateFormat.format(date),lembarobat="",status="",rincianobat="",finger="",tgl_lahir="",latin_racikan="",namaobat1="",namaobat2="",
                   bb="",alergi="",keterangan="",aturan="";
    private double total=0,jumlahtotal=0;
    private Properties prop = new Properties();
    private DlgCariAturanPakai aturanpakai=new DlgCariAturanPakai(null,false);
    private int i=0,pilihan=0,getno=0,jmlbpjs=0,jmlinacbg=0,totalbpjs=0,totalinacbg=0;
    ...
    private void initComponents() {
        ...
        ppCetakEResep = new javax.swing.JMenuItem();
        ...
        ppLembarObatKronis = new javax.swing.JMenuItem();
        ...
        ppCetakEResep.setBackground(new java.awt.Color(255, 255, 254));
        ppCetakEResep.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppCetakEResep.setForeground(new java.awt.Color(50, 50, 50));
        ppCetakEResep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppCetakEResep.setText("Cetak E-Resep");
        ppCetakEResep.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppCetakEResep.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppCetakEResep.setName("ppCetakEresep"); // NOI18N
        ppCetakEResep.setPreferredSize(new java.awt.Dimension(225, 25));
        ppCetakEResep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppCetakEResepActionPerformed(evt);
            }
        });
        Popup2.add(ppCetakEResep);
        ...
        ppLembarObatKronis.setBackground(new java.awt.Color(255, 255, 254));
        ppLembarObatKronis.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppLembarObatKronis.setForeground(new java.awt.Color(50, 50, 50));
        ppLembarObatKronis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppLembarObatKronis.setText("Lembar Pemberian Obat Kronis");
        ppLembarObatKronis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppLembarObatKronis.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppLembarObatKronis.setName("ppLembarObatKronis"); // NOI18N
        ppLembarObatKronis.setPreferredSize(new java.awt.Dimension(225, 25));
        ppLembarObatKronis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppLembarObatKronisActionPerformed(evt);
            }
        });
        Popup2.add(ppLembarObatKronis);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-05-2022 07:14:43" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-05-2022 07:14:44" }));
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-05-2022" }));
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                try {
                    ...
                    while(rs.next()){
                        Sequel.menyimpan("temporary_resep","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",38,new String[]{
                            "0",rs.getString("nama_brng"),Sequel.cariIsi("select aturan from aturan_pakai where tgl_perawatan='"+rs.getString("tgl_perawatan")+"' and jam='"+rs.getString("jam")+"' and no_rawat='"+rs.getString("no_rawat")+"' and kode_brng='"+rs.getString("kode_brng")+"'"),intToRoman(rs.getInt("jml")),Valid.SetAngka(rs.getDouble("total")),"","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""
                        });
                    }
                } catch (Exception e) {
    ...
    private void ppCetakEResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCetakEResepActionPerformed
        if(tabMode.getRowCount()==0){
             JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
             TNoRw.requestFocus();
        }else if(TPasien.getText().trim().equals("")){
            ...
            try {
                ...
                try {
                    ...
                    rs=ps.executeQuery();
                    while(rs.next()){
                        namaobat1 = rs.getString("nama_brng");
                        Sequel.menyimpan("temporary_resep","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",38,new String[]{
                            "0",namaobat1,rs.getString("aturan"),"No. "+intToRoman(rs.getInt("jml")),"","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""
                        });
                    }
                } catch (Exception e) {
                    System.out.println("Notif 1 : "+e);
                ...
                psracikan=koneksi.prepareStatement(
                    "select obat_racikan.no_racik,obat_racikan.nama_racik,obat_racikan.tgl_perawatan,obat_racikan.jam," +
                    "obat_racikan.no_rawat,obat_racikan.aturan_pakai,obat_racikan.jml_dr,obat_racikan.keterangan,metode_racik.nm_racik " +
                    "from resep_obat inner join reg_periksa inner join " +
                    "obat_racikan inner join metode_racik on resep_obat.no_rawat=reg_periksa.no_rawat " +
                    "and obat_racikan.kd_racik=metode_racik.kd_racik " +
                    "and resep_obat.no_rawat=obat_racikan.no_rawat and " +
                ...
                try {
                    ...
                    while(rsracikan.next()){
                        ...
                        try {
                            ...
                            total=0;
                            while(rs2.next()){
                                namaobat2 = rs2.getString("nama_brng");
//                                rincianobat=namaobat2+" No. "+intToRoman(rs2.getInt("jml"))+"\n"+rincianobat;
                                rincianobat=namaobat2+"\n"+rincianobat;
                            }                                
                        } catch (Exception e) {
                            System.out.println("Notifikasi Detail Racikan : "+e);
                        } finally{
            ...
            tgl_lahir=Sequel.cariIsi("select tgl_lahir from pasien where no_rkm_medis =?",TNoRm.getText());
            ...
            Valid.MyReport("rptEResep.jasper",param,"::[ Lembar Pemberian Obat Sudah Validasi]::");
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_ppCetakEResepActionPerformed

    private void ppLembarObatKronisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObatKronisActionPerformed
        if(tabMode.getRowCount()==0){
             JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
             TNoRw.requestFocus();
        }else if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            // Pemanggilan Obat Ke Nota
            try{
                psnotakronis=koneksi.prepareStatement(
                ...
                try{
                    psnotakronis.setString(1,Valid.SetTgl(DTPBeri.getSelectedItem()+""));
                    psnotakronis.setString(2,cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem());
                    psnotakronis.setString(3,TNoRw.getText());
                    rsnotakronis = psnotakronis.executeQuery();
                    
                    Sequel.queryu("truncate table temporary_obat");
                    while(rsnotakronis.next()){
                        keterangan = Sequel.cariIsi(
                                    "select keterangan from detail_pemberian_keterangan " +
                                    "where tgl_perawatan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' and jam='"+cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem()+"' "+
                                    "and no_rawat='"+TNoRw.getText()+"' and kode_brng='"+rsnotakronis.getString("kode_brng")+"'");
                        
                        if(keterangan.trim().equalsIgnoreCase("kronis")){
                           aturan = Sequel.cariIsi(
                                   "select aturan from aturan_pakai where tgl_perawatan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' and jam='"+cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem()+"' "+
                                   "and no_rawat='"+TNoRw.getText()+"' and kode_brng='"+rsnotakronis.getString("kode_brng")+"'");
                           
                           char firstChar = aturan.charAt(0);
                           int signabpjs = Integer.parseInt(String.valueOf(firstChar));
                           jmlinacbg = (signabpjs*30) - ((signabpjs*30)-(signabpjs*7));
                           totalinacbg = ((signabpjs*30)*rsnotakronis.getInt("biaya_obat")) - (((signabpjs*30)*rsnotakronis.getInt("biaya_obat"))-((signabpjs*7)*rsnotakronis.getInt("biaya_obat")));
                           
                           String s1 = Integer.toString(jmlinacbg);
                           String s2 = Integer.toString(totalinacbg);
                           
                           Sequel.menyimpan("temporary_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",38,new String[]{
                            "0",rsnotakronis.getString("nama_brng"),s1,s2,"","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""
                           });
                           
                        }else{
                           Sequel.queryu("truncate table temporary_obat");
                           Sequel.menyimpan("temporary_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",38,new String[]{
                            "0",rsnotakronis.getString("nama_brng"),rsnotakronis.getString("jml"),rsnotakronis.getString("biaya_obat"),"","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""
                           });
                        }
                    }
                   ...
                   Valid.MyReport("rptLembarObatInacbg.jasper",param,"::[ Lembar Obat Kronis ]::");
                    
                } catch (Exception e){
                    System.out.println("Notif Query Kronis: "+e);
                }
            } catch(Exception e){
                System.out.println("Notif Nota Kronis: "+e);
            }
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_ppLembarObatKronisActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem ppCetakEResep;
    ...
    private javax.swing.JMenuItem ppLembarObatKronis;
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    try {
                        ...
                        while(rs2.next()){
                            tabMode.addRow(new String[]{
                                "",rs2.getString("nama_brng")+" ("+ Sequel.cariIsi("select keterangan from detail_pemberian_keterangan where tgl_perawatan='"+rs.getString("tgl_perawatan")+"' and jam = '"+rs.getString("jam")+"' and kode_brng ='"+rs2.getString("kode_brng")+"'") +")",
                    ...
                    try {
                        ...
                        while(rsracikan.next()){
                            ...
                            try {
                                ...
                                while(rs2.next()){
                                    tabMode.addRow(new String[]{
                                        "","   "+rs2.getString("nama_brng")+" ("+ Sequel.cariIsi("select keterangan from detail_pemberian_keterangan where tgl_perawatan='"+rs.getString("tgl_perawatan")+"' and jam = '"+rs.getString("jam")+"' and kode_brng ='"+rs2.getString("kode_brng")+"'") +")",rs2.getString("jml")+"  x  "+Valid.SetAngka(rs2.getDouble("biaya_obat"))+
                                        " + "+Valid.SetAngka(rs2.getDouble("embalase"))+" + "+Valid.SetAngka(rs2.getDouble("tuslah"))+" = "+Valid.SetAngka(rs2.getDouble("total")),
                                        ""
                                    });
                                    total=total+rs2.getDouble("total");
