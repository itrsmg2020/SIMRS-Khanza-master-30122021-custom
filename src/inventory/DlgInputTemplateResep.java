 ...
 * @author dosen
 */
public final class DlgInputTemplateResep extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgInputTemplateResep(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                column.setPreferredWidth(20);
    ...
    private void initComponents() {
        ...
        BtnSimpan.setPreferredSize(new java.awt.Dimension(39, 23));
        ...
        BtnTambah1.setPreferredSize(new java.awt.Dimension(35, 23));
        ...
        BtnHapus.setPreferredSize(new java.awt.Dimension(35, 23));
        ...
        BtnKeluar.setPreferredSize(new java.awt.Dimension(35, 23));
        ...
        jLabel11.setText("Nama Resep :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(700, 70, 70, 23);

        NamaResep.setHighlighter(null);
        NamaResep.setName("NamaResep"); // NOI18N
        NamaResep.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NamaResepKeyPressed(evt);
            }
        });
        FormInput.add(NamaResep);
        NamaResep.setBounds(770, 70, 220, 23);
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-06-2022" }));
        ...
        ChkResep.setBorder(null);
        ChkResep.setSelected(true);
        ChkResep.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ChkResep.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ChkResep.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ChkResep.setName("ChkResep"); // NOI18N
        ChkResep.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ChkResepItemStateChanged(evt);
            }
        });
        FormInput.add(ChkResep);
        ChkResep.setBounds(990, 70, 23, 23);
        ...
        jLabel12.setBounds(455, 72, 70, 23);
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Valid.textKosong(NamaResep,"No.Resep");
        }else if(ttl<=0){
            ...
            if (reply == JOptionPane.YES_OPTION) {   
                ...
                if(ubah==false){
                    if(Sequel.menyimpantf2("resep_obat","?,?,?,?,?,?,?,?","Nomer Resep",8,new String[]{
                        NamaResep.getText(),Valid.SetTgl(DTPBeri.getSelectedItem()+""),
                    ...
                    Sequel.meghapus("resep_dokter","no_resep",NamaResep.getText());
                    Sequel.meghapus("resep_dokter_racikan","no_resep",NamaResep.getText());
                    Sequel.meghapus("resep_dokter_racikan_detail","no_resep",NamaResep.getText());
                    ubah=false;
                    simpandata();
                }                                                      
                ...
                if(sukses == true){
                    ...
                    try{
                        ...
                        try{
                            ps.setString(1, NamaResep.getText());
                            rs=ps.executeQuery();
                            while(rs.next()){
                        ...
                        psracikan=koneksi.prepareStatement(
                                ...
                                "order by no_racik");
                        try{
                            psracikan.setString(1, NamaResep.getText());
                            ...
                            while(rsracikan.next()){
                                ...
                                try{
                                    ...
                                    psracikan2.setString(2, NamaResep.getText());
                    ...
                    param.put("noresep",NamaResep.getText());
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    private void KdDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdDokterKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            ...
            Valid.pindah(evt,NamaResep,BtnSimpan);
        }
    ...
    private void ChkResepItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkResepItemStateChanged
        if(ChkResep.isSelected()==true){
            NamaResep.setEditable(false);
            NamaResep.setBackground(new Color(245,250,240));
            emptTeksobat();
        }else if(ChkResep.isSelected()==false){
            NamaResep.setEditable(true);
            NamaResep.setBackground(new Color(250,255,245));
            NamaResep.setText("");
        }
    }//GEN-LAST:event_ChkResepItemStateChanged

    private void NamaResepKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NamaResepKeyPressed
        Valid.pindah(evt,cmbDtk,KdDokter);
    }//GEN-LAST:event_NamaResepKeyPressed
    ...
    private void cmbDtkKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbDtkKeyPressed
        Valid.pindah(evt,cmbMnt,NamaResep);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgInputTemplateResep dialog = new DlgInputTemplateResep(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox NamaResep;
    ...
    public void emptTeksobat() {
        if(ChkResep.isSelected()==true){
            Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_resep,4),signed)),0) from resep_obat where tgl_perawatan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' ",
                DTPBeri.getSelectedItem().toString().substring(6,10)+DTPBeri.getSelectedItem().toString().substring(3,5)+DTPBeri.getSelectedItem().toString().substring(0,2),4,NamaResep);        
        } 
    }
                        ...
                        try {
                            ...
                            if(carikapasitas.next()){ 
                                if(Sequel.menyimpantf2("resep_dokter","?,?,?,?","data",4,new String[]{
                                    NamaResep.getText(),tbResep.getValueAt(i,2).toString(),
            ...
            for(i=0;i<tbObatResepRacikan.getRowCount();i++){ 
                if(Valid.SetAngka(tbObatResepRacikan.getValueAt(i,4).toString())>0){ 
                    if(Sequel.menyimpantf2("resep_dokter_racikan","?,?,?,?,?,?,?","resep obat racikan",7,new String[]{
                       NamaResep.getText(),tbObatResepRacikan.getValueAt(i,0).toString(),tbObatResepRacikan.getValueAt(i,1).toString(),
            ...
            for(i=0;i<tbDetailResepObatRacikan.getRowCount();i++){ 
                if(Valid.SetAngka(tbDetailResepObatRacikan.getValueAt(i,13).toString())>0){
                    if(Sequel.menyimpantf2("resep_dokter_racikan_detail","?,?,?,?,?,?,?","resep dokter racikan detail",7,new String[]{
                        NamaResep.getText(),tbDetailResepObatRacikan.getValueAt(i,0).toString(),tbDetailResepObatRacikan.getValueAt(i,1).toString(),
