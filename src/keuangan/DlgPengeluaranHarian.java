...
public final class DlgPengeluaranHarian extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cetakkwitansi.setText("Cetak Kwitansi Pengeluaran");
        ...
        tbResep.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-01-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-01-2022" }));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-01-2022 09:16:41" }));
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void cetakkwitansiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakkwitansiActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(Pengeluaran.getText().trim().equals("")){
            Valid.textKosong(Pengeluaran,"Pengeluaran");
        }else if(KdPtg.getText().trim().equals("")||NmPtg.getText().trim().equals("")){
                ...
                try {
                    if(Valid.SetAngka(tabMode.getValueAt(i,0).toString())>0){
                        Sequel.menyimpan("temporary","'0','"+
                            ...
                            tabMode.getValueAt(i,10).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','',''","Transaksi Pengeluaran");
                    }
                } catch (Exception e) {
                }
            }

            Valid.panggilUrl("billing/LaporanKeuangan2.php?kode="+Nomor.getText()+"&Tanggal="+Valid.SetTgl(Tanggal.getSelectedItem()+"")+"&nama="+NmKategori.getText().replaceAll(" ","_")+"&petugas="+NmPtg.getText().replaceAll(" ","_")+"&pengeluaran="+Pengeluaran.getText().replaceAll(" ","_")+"&keterangan="+Keterangan.getText().replaceAll(" ","_")+"&nom="+Pengeluaran.getText().replaceAll(" ","_")+"&kategori="+NmKategori.getText().replaceAll(" ","_"));
        }
        this.setCursor(Cursor.getDefaultCursor());
